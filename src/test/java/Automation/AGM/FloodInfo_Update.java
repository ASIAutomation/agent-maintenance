...
public class FloodInfo_Update extends TestBase
{
	public static final Logger log = Logger.getLogger(FloodInfo_Update.class.getName());
	...
	{
		String[][] data = GetData("FloodInfo_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting FloodInfo Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_DriveRep_Update(String casenum, String agentid, String fldeffdate, String note) throws InterruptedException 
	{
		...
		AI.CheckApptForFlood("Y");
		AI.TypeFloodEffectiveDate(fldeffdate);
		Pause(2000);
		AI.ClickNext();
