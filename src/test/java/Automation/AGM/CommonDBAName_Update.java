...
public class CommonDBAName_Update extends TestBase{
	public static final Logger log = Logger.getLogger(CommonDBAName_Update.class.getName());
	...
	{
		String[][] data = GetData("CommonName_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting CommonDBA Name Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_CommonDBAName_Update(String casenum, String agentid, String commonname, String note) throws InterruptedException 
	{
