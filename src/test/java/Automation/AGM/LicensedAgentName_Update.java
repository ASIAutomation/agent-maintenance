...
public class LicensedAgentName_Update extends TestBase{
	public static final Logger log = Logger.getLogger(LicensedAgentName_Update.class.getName());
	...
	{
		String[][] data = GetData("LicensedAgentName_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting LicensedAgent Name Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_LicensedAgentName_Update(String casenum, String agentid, String licensedagentname, String note) throws InterruptedException 
	{
		...
		AI.TypeLicensedAgentName(licensedagentname);;
		Pause(2000);
		AI.ClickNext();
