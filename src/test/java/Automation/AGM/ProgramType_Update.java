...
public class ProgramType_Update extends TestBase
{
	public static final Logger log = Logger.getLogger(ProgramType_Update.class.getName());
	...
	{
		String[][] data = GetData("ProgramType_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting ProgramType Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_ProgramType_Update(String casenum, String agentid, String programtype, String note) throws InterruptedException 
	{
		...
		AI.SelectProgramType(programtype);
		Pause(2000);
		AI.ClickNext();
