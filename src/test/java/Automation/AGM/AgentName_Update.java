...
public class AgentName_Update extends TestBase
{

	public static final Logger log = Logger.getLogger(AgentName_Update.class.getName());
	...
	{
		String[][] data = GetData("AgentName_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
			Log("====================================== Starting Agent Name Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_AgentName_Update(String casenum, String agentid, String agentname, String note) throws InterruptedException 
	{
