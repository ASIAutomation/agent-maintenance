...
public class MarketingRep_Update extends TestBase{

	public static final Logger log = Logger.getLogger(MarketingRep_Update.class.getName());
	...
	{
		String[][] data = GetData("MarketingRep_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting MarketingRep Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_MarketingRep_Update(String casenum, String agentid, String marketingrep, String note) throws InterruptedException 
	{
		...
		AI.SelectMarketingRep(marketingrep);
		Pause(2000);
		AI.ClickNext();
