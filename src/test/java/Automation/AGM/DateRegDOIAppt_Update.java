...
public class DateRegDOIAppt_Update extends TestBase
{
	public static final Logger log = Logger.getLogger(DateRegDOIAppt_Update.class.getName());
	...
	{
		String[][] data = GetData("DateRegDOIAppt_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting DateRegDOIAppt Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_DriveRep_Update(String casenum, String agentid, String dateregorapptdoi, String note) throws InterruptedException 
	{
		...
		AI.TypeDateRegorApptDOI(dateregorapptdoi);
		Pause(2000);
		AI.ClickNext();
	...
	public void EndBatch() {
		QuitBrowser();
		Log("\n====================================== End DateRegDOIAppt Update Batch ======================================");
	}
