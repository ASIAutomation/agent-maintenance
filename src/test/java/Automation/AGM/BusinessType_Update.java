...
public class BusinessType_Update extends TestBase{
	public static final Logger log = Logger.getLogger(BusinessType_Update.class.getName());
	...
	{
		String[][] data = GetData("BusinessType_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting BusinessType Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_BusinessType_Update(String casenum, String agentid, String businesstype, String trackdate, String note) throws InterruptedException 
	{
		...
		AI.SelectBusinessType(businesstype);
