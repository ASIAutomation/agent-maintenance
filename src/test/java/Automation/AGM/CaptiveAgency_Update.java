...
public class CaptiveAgency_Update extends TestBase
{
	public static final Logger log = Logger.getLogger(CaptiveAgency_Update.class.getName());
	...
	{
		String[][] data = GetData("CaptiveAgency_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting CaptiveAgency Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_DriveRep_Update(String casenum, String agentid, String captiveagency, String note) throws InterruptedException 
	{
	...
	public void EndBatch() {
		QuitBrowser();
		Log("\n====================================== End CaptiveAgency Update Batch ======================================");
	}
