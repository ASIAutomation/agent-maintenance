...
public class DateTermedwDOI_Update extends TestBase
{
	public static final Logger log = Logger.getLogger(DateTermedwDOI_Update.class.getName());
	...
	{
		String[][] data = GetData("DateTermedwDOI_Update", "AGM_Master");
		return data;
	}
	...
	public void SetUp() {
		SetLog();
		Log("====================================== Starting DateTermedwDOI Update Batch ======================================");
		InitAGM("Chrome");
		//Initialize Drivers
	...
	public void Run_DriveRep_Update(String casenum, String agentid, String datetermeddoi, String note) throws InterruptedException 
	{
		...
		AI.TypeDateTermedDOI(datetermeddoi);
		Pause(2000);
		AI.ClickNext();
	...
	public void EndBatch() {
		QuitBrowser();
		Log("\n====================================== End DateTermedwDOI Update Batch ======================================");
	}
}
